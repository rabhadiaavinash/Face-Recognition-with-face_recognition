...
known_image_1 = face_recognition.load_image_file("virat1.jpg")
known_image_2 = face_recognition.load_image_file("virat2.jpg")
known_image_3 = face_recognition.load_image_file("virat3.jpg")
known_image_4 = face_recognition.load_image_file("PMmodi.jpg")

# Crate names for each loaded image:
names = ["virat1.jpg", "virat2.jpg", "virat3.jpg", "PMmodi.jpg"]

# Load unknown image (this image is going to be compared against all the previous loaded images):
unknown_image = face_recognition.load_image_file("virat4.jpg")
